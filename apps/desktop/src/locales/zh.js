export default {
  ...
  dashboard: {
    ...
    signInNow: '去登录',
    statPublishedContent: '已发布内容',
    statTrendUp: '↑',
    statTrendDown: '↓',
    statChangeWeek: '较上周 {percent}',
    statViews: '总阅读',
    statComments: '总评论',
    statFollowers: '总粉丝',
    panelPublishStats: '发布统计',
    statTotalPublished: '累计发布',
    statSuccess: '成功',
    statFailed: '失败',
    statSuccessRate: '成功率',
  ...
  collection: {
    ...
    tabRecords: '文案库',
    libraryTitle: '文案库',
    libraryEmptyTitle: '暂无文案',
    libraryEmptyDesc: '在「内容采集」标签页采集内容后，会在这里生成文案列表',
