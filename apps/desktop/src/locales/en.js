export default {
  ...
  settings: {
    ...
    cache: {
      title: 'Cache Cleanup',
      subtitle: 'Intermediate artifacts produced by video composition and film engineering in the system temp directory. Safe to clean to free disk space.',
      dirLabel: 'Cache directory',
      totalSize: 'Total cache size',
      fileCount: 'Cache files',
      clearBtn: 'Clear Cache',
      clearing: 'Clearing…',
      empty: 'No cache files yet',
      autoClearHint: 'Cleaning only removes temporary cache; it will not affect finished videos or the media library saved in history.',
      clearedToast: 'Freed {size} of cache',
      clearFailedToast: 'Failed to clear cache, please try again later',
      itemStory2Video: 'Video composition cache',
      itemFilmEngineering: 'Film engineering cache',
    },
    feedback: {
      title: 'User Feedback',
  ...
  home: {
    ...
    loginExpiredBanner: {
      ...
      saveAllBtn: 'Save All',
      saveAllBtnCount: (ctx) => 'Save All (' + ctx.named('count') + ')',
      saveAllSuccess: (ctx) => 'Saved ' + ctx.named('count') + ' account(s)',
      saveAllPartial: (ctx) => ctx.named('count') + ' account(s) failed to save, please check',
      saveAllNone: 'No unsaved logins',
      saveAllFailed: 'Batch save failed, please retry',
    },
  },
  publishPage: {
    draftsTitle: 'Drafts',
  ...
  filmEngineering: {
    ...
    "loadMoreFailed": "Failed to load next page of shots",
    "detailLoadFailed": "Failed to load shot detail",
    "shotsUnit": "shots",
    "copyBatchFailed": "Batch copy failed",
    "exportFailed": "Export failed",
    "generateFailedMsg": "Generation failed",
    "video": {"entry":"Generate video","title":"Shot video generation","selectedCount":"{n} shots selected","aspect":"Aspect ratio","aspect169":"16:9 landscape","aspect916":"9:16 portrait","aspectSource":"Match source","seconds":"Duration","secondsN":"{n}s","batchHint":"Up to {max} shots per batch. No model calls or cost before you confirm.","start":"Start generation","tooManyShots":"Up to {max} shots per batch, please select fewer","noShots":"Select shots first","confirmTitle":"Cost confirmation","confirmHint":"Will generate video for {totalShots} shots (aspect {aspect} / duration {seconds}s, provider: {provider}). Billing starts only after you confirm.","confirm":"Confirm & generate","cancel":"Cancel","statusPending":"Pending","statusSuccess":"Success","statusFailed":"Failed","retry":"Retry","generating":"Generating…","doneTitle":"Final video ready","openFolder":"Open folder","saveAs":"Save as","newRun":"New batch","cancelled":"Cancelled","failedTitle":"Generation failed","viewModelSettings":"Open model settings","noModel":"No default video model configured. Set up a video provider (e.g. Seedance / Kling / Veo) as default in model settings, then retry."},
    "production": {
    "entry": "Full production",
    "entryDesc": "Generate imported shots in batches and compose the final video; billing starts only after per-batch confirmation, with resume support.",
    "title": "Batch Production",
    "taskIdLabel": "Task ID",
    "taskIdPlaceholder": "Used for the production ledger and resume, e.g. my-task-01 (letters/digits/._- only)",
    "taskIdInvalid": "Task ID allows letters, digits, ._- only, length 1-64",
    "planTitle": "Batch plan preview",
    "planSummary": "{batches} batches (up to {size} shots each), {shots} shots selected",
    "diskEstimate": "Est. disk",
    "wallclockEstimate": "Est. time",
    "mediaRoot": "Media folder",
    "startConfirm": "Start production",
    "batchCard": "Batch {i}/{n} · {count} shots · {aspect} · {seconds}s",
    "confirmBatch": "Confirm this batch",
    "batchHint": "Generation starts only after confirming; zero model calls and zero cost before confirmation.",
    "remaining": "Batches left",
    "confirmedBudget": "{count} shots confirmed so far",
    "statusPending": "Pending",
    "statusRunning": "Running",
    "statusDone": "Done",
    "statusFailed": "Failed",
    "shotsDone": "{done}/{total} shots",
    "batchDetail": "Batch details",
    "retryShot": "Retry shot",
    "retrying": "Retrying…",
    "resumeTitle": "Resume",
    "resumeHint": "Enter a previous task ID to restore batch/shot progress read-only (no generation, no cost).",
    "resumeBtn": "Resume task",
    "noLedger": "No production ledger found for this task. Check the task ID or start a production first.",
    "recycleGuide": "Recycle originals locally before refining: remote result links expire and would require regeneration.",
    "recycleBtn": "Recycle all originals",
    "recycling": "Recycling…",
    "recycled": "Recycled {ok}/{total} files to {dir}",
    "manifestReady": "All batches converged — render manifest has {count} entries",
    "compose": "Compose final",
    "composing": "Composing…",
    "doneTitle": "Final video ready",
    "failedTitle": "Run failed",
    "manifestMissing": "Cannot compose yet: manifest not converged ({error})",
    "providerMissing": "No default video model configured. Set up a video provider (Seedance / Kling / Veo / CogVideo) in model settings and make it default, then retry.",
    "close": "Close",
    "minutes": "{n} min",
    "gb": "{n} GB",
    "mb": "{n} MB"
...
knowledgeBase: {
  ...
  viralAnalysis: {
    ...
    goRewrite: 'Rewrite',
    topicPrefillNotice: 'Topic imported from trending picks. Click "Analyze" to start.',
  ...
  hotTopics: {
    ...
    channels: {
      ...
      sina_finance: 'Sina Finance', ithome_tech: 'IT Home',
      'baidu-finance': 'Baidu Finance Board', 'sina-finance': 'Sina Finance Roll', 'ithome-tech': 'IT Home Hot',
      'weibo-emotion': 'Weibo Emotion', 'weibo-health': 'Weibo Health',
    },
    selectAll: 'Select all',
    deselectAll: 'Deselect all',
    selectedCount: (ctx) => ctx.named('count') + ' selected',
    ...
    emptyCategoryTitle: 'No topics in this category',
    emptyCategoryDesc: 'No topics here yet. You can fetch this category trending boards on demand',
    boostAction: 'Fetch this category',
    multiBadge: 'Multi-board',
    multiBadgeTip: 'Also trending on: {sources}',
    heatScoreTip: 'Source rank #{rank} · heat {heat}',
    trendUp: 'Rising since last refresh',
    trendDown: 'Falling since last refresh',
    trendNew: 'New',
