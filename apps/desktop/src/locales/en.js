export default {
  ...
  dashboard: {
    pageTitle: 'Dashboard',
    pageSubtitle: 'Publish data and trends across platforms',
  ...
  collection: {
    ...
    libraryEmptyTitle: 'No copies yet',
    libraryEmptyDesc: 'Collected content will appear here as copies after collecting from the Collection tab',
