export default {
  ...
  settings: {
    diagnose: {
      title: 'Network & Scheduler Diagnostics',
      hint: 'One-click check of local network connectivity and rate-limit scheduling health (runs automatically, no parameters needed).',
  ...
  filmEngineering: {
    ...
    "canvas": {
      "title": "Film Canvas",
      "subtitle": "Fill in the script, wire reference images, split into shots and drive to the final film in one click.",
      "scriptPlaceholder": "Paste the script body; blank lines separate scenes. Click Split Shots to auto-apply the prompt architecture into per-shot nodes.",
      "llmEnabled": "Enable LLM polish",
      "engineUnavailable": "Film engine unavailable",
      "engineUnavailableDesc": "The bundled film-kit assets are missing or failed validation. Check the installation and retry.",
      "noDesktop": "Desktop capabilities are not available in this environment",
      "scriptNode": "Script",
      "noTitle": "Untitled script",
      "scriptChars": "{n} chars",
      "refCharacter": "Character ref",
      "refScene": "Scene ref",
      "deleteNode": "Delete node",
      "refInjected": "{n} refs injected",
      "statusIdle": "Idle",
  ...
  memberCenter: {
    ...
    navSubscription: 'Plan & Subscription',
    navOrders: 'Orders & Billing',
    navUsage: 'Usage & Quota',
    navMessages: 'Messages',
    navHelp: 'Help & About',
    sessionsTitle: 'Signed-in devices',
    sessionsEmptyHint: 'No other active devices.',
    ...
    messagesEmptyHint: 'No messages right now.',
    markAllRead: 'Mark all as read',
    markingRead: 'Marking...',
    untitledMessage: '(untitled)',
    ordersTitle: 'Orders & Billing',
    ordersEmptyHint: 'Order history is coming soon.',
    helpTitle: 'Help & Support',
    helpHint: 'Need help? Contact support or browse the docs.'
  },
knowledgeBase: {
