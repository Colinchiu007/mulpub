export default {
  ...
  collection: {
    ...
    libraryEmptyTitle: 'No copy yet',
    libraryEmptyDesc: 'Collect an article on the Content Collection tab, or click Rewrite on an existing copy, to build this list',
