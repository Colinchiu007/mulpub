<template>
  <div class="cohere-card" style="cursor:default;padding:16px">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:var(--space-md);padding-bottom:var(--space-sm);border-bottom:1px solid var(--border)">
      <span style="font-weight:600;font-size: var(--font-size-sm)"><el-icon><Document /></el-icon> {{ $t('intelligence.templatePickerTitle') }}</span>
...
function categoryLabel(cat) {
  const labels = { report: t('intelligence.categoryReport'), marketing: t('intelligence.categoryMarketing'), education: t('intelligence.categoryEducation'), social: t('intelligence.categorySocial') }
