...
.record-action { min-height: 26px; padding: 2px 8px; border: 1px solid #e5e7ef; border-radius: 5px; background: #fff; color: #68708b; font-size: var(--font-size-xs); cursor: pointer; }
