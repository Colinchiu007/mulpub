...
vi.mock("@element-plus/icons-vue", () => { const __g = ["__esModule", "then", "catch", "default"]; return new Proxy({ UploadFilled: { template: "<span>U</span>" }, Timer: { template: "<i />" }, DataLine: { template: "<i />" }, Search: { template: "<i />" }, EditPen: { template: "<i />" }, DocumentCopy: { template: "<i />" }, InfoFilled: { template: "<i />" }, Key: { template: "<i />" }, CaretTop: { template: "<i />" }, CaretBottom: { template: "<i />" }, CaretRight: { template: "<i />" }, MagicStick: { template: "<i />" }, FolderAdd: { template: "<i />" }, Link: { template: "<i />" }, Document: { template: "<i />" }, View: { template: "<i />" }, ChatDotRound: { template: "<i />" }, Promotion: { template: "<i />" }, TrendCharts: { template: "<i />" }, VideoCamera: { template: "<i />" }, Connection: { template: "<i />" }, Cpu: { template: "<i />" }, Trophy: { template: "<i />" } }, { has: () => true, get: (t, p) => (p in t ? t[p] : (typeof p === "string" && !__g.includes(p) ? { template: "<i />" } : undefined)) }); });
