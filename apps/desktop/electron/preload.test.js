...
describe('preload 子模块方法数', () => {
  ...
  it('合并后 api 总键数应为 322（P2-2 generateAiCover + pipelineCancelRun + P3-7 listPlatformCollections + servicesGetStatus + urlCollectNeedsStealth + promptLibraryGet/Save/Activate + updateInstallNow + onUploadProgress）', () => {
