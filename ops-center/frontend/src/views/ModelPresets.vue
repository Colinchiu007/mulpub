    ...
    <el-dialog v-model="showDialog" :title="editing ? `编辑预设：${form.id}` : '新增预设'" width="760px">
      <el-form label-width="150px" label-position="left">
        ...
        <el-form-item label="每分钟连接次数">
          ...
          <span style="margin-left:8px;color:#888;font-size: var(--font-size-xs)">留空表示未配置，前端使用默认限流；正整数</span>
        </el-form-item>
        <el-form-item label="5小时限额次数">
          ...
          <span style="margin-left:8px;color:#888;font-size: var(--font-size-xs)">留空表示未配置；5 小时内请求次数上限（正整数）</span>
        </el-form-item>
        ...
        <el-form-item label="前端显示">
          ...
          <span style="margin-left:8px;color:#888;font-size: var(--font-size-xs)">关闭后不在前端【模型设置】中显示该预设</span>
        </el-form-item>
