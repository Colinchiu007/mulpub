...
.result-block { background: var(--color-bg-disabled); border: 1px solid var(--color-border-regular); border-radius: 8px; padding: 12px; margin-bottom: 12px; }
.result-title { font-weight: 600; font-size: var(--font-size-sm); margin-bottom: 8px; display: flex; align-items: center; gap: 8px; }
pre { margin: 0; white-space: pre-wrap; word-break: break-word; font-family: ui-monospace, "Cascadia Code", Consolas, monospace; font-size: 12.5px; color: var(--color-text-primary); }
</style>